...
class Program
{
    ...
    const string SegmentedDataset = @"C:\Users\SCSM11\Downloads\SegmentedDataset";
    //public const string TestImage = @"C:\MMU\Degree\Sem 5\TPC\MedicalSegmentationPSO\MedicalSegmentationPSO\Tr-no_10.jpg";
    public const string TestImage = @"C:\Users\SCSM11\Downloads\Tr-no_10.jpg";
    ...
    static void Main()
    {
        ...
        //sw dataset segment
        //Console.WriteLine("=== Shared Memory PSO Dataset Segmentation ===");
